...
HI_S32 SAMPLE_MISC_VpssDumpSrcImage(VPSS_GRP Grp,HI_U32 u32FrameCnt)
{
   ...
   /* make file name */
    ...
    bSendToVgs = HI_TRUE;//((stFrame.stVFrame.enCompressMode > 0) || (VIDEO_FORMAT_LINEAR != stFrame.stVFrame.enVideoFormat));
...
{	 
    ...
    printf("Usage: ./vpss_src_dump [Grp] [Count] \n");
