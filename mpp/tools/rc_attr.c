...
{\
    ...
    printf("\n\t para: \n");    \
    printf("\tstattime, statistic time ,unit:second\n");   \
    printf("\tbitrate, unit:kbps\n");    \
    printf("\tgop, frame numbers between two IDR frames,unit:frame\n");   \
    printf("\tqpdelta, the qp delta between IDR and P frames\n");    \
    printf("\tmqpdelta, the qp delta between mb line and the start qp of frame\n");    \
    printf("\tmaxqp,     max qp\n");   \
}
