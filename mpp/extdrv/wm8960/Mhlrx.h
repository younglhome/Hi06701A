...
#if Debug_message
	#define MHLRX_DEBUG_PRINTF(x)  //printk  x
	#define EQ_DEBUG_PRINTF(x) //printk  x
	#define EQ_PORT0_PRINTF(x) //printk  x
	#define EQ_PORT1_PRINTF(x) //printk  x
	#define VIDEOTIMNG_DEBUG_PRINTF(x)  //printk  x
	#define IT6802_DEBUG_INT_PRINTF(x) //printk  x
	#define IT6802_MHL_DEBUG_PRINTF(x) //printf x
	#define MHL_MSC_DEBUG_PRINTF(x) //printk x
	#define HDMIRX_VIDEO_PRINTF(x)   printk  x
	#define HDMIRX_AUDIO_PRINTF(x)  //printk  x
	#define HDMIRX_DEBUG_PRINT(x) //printk x
	#define CEC_DEBUG_PRINTF(x) //printk x
	#define EDID_DEBUG_PRINTF(x) //printk  x
	#define IT680X_DEBUG_PRINTF(x) printk  x
	#define VSDB_DEBUG_PRINTF(x) //printk  x
	#define RCP_DEBUG_PRINTF(x)  //printk  x
	#define MHL3D_DEBUG_PRINTF(x) //printk  x
	#define CBUS_CAL_PRINTF(x)  //printk  x
	#define MHL_INT_PRINTF(x)  //printk  x
#else
