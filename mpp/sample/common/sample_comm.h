...
#define SAMPLE_AUDIO_PTNUMPERFRM   (48 * 10)//sample rate:48k


#define PHIDI_AUDIO_AI_DEV0 (0)
#define PHIDI_AUDIO_AI_DEV1 (1)
#define PHIDI_AUDIO_AO_DEV0 (0)
#define PHIDI_AUDIO_AO_DEV1 (1)

#define PHIDI_AUDIO_AO_DEV_HDMI          (PHIDI_AUDIO_AO_DEV1)
#define PHIDI_AUDIO_AO_DEV_AUDIO_CODEC   (PHIDI_AUDIO_AO_DEV0)

#define PHIDI_AUDIO_AI_DEV_HDMI          (PHIDI_AUDIO_AI_DEV0)
#define PHIDI_AUDIO_AI_DEV_AUDIO_CODEC   (PHIDI_AUDIO_AI_DEV1)

#define SAMPLE_AUDIO_HDMI_AO_DEV (PHIDI_AUDIO_AO_DEV1)
#define SAMPLE_AUDIO_AI_DEV      (PHIDI_AUDIO_AI_DEV1)
#define SAMPLE_AUDIO_AO_DEV      (PHIDI_AUDIO_AO_DEV1)
