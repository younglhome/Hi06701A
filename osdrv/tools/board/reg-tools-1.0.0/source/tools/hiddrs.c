...
#define DDRC_BASE_ADDR 0x12110000

#define DDRC_MAP_LENGTH 0x20000

#define DDRC0_ADDR 0x8000

#if defined(hi3521a) || defined(hi3520dv300)
#define DDRC_TEST_EN 0x010
#define DDRC_TEST7 0x270
...
#if defined(hi3521a) || defined(hi3520dv300)
	/* for 3521a set single trigger,for other chip choose channel */
